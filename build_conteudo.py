...
# f03 — TRAÇAR-LETRA: escrever A e O com o dedo
add(id="f03", mec="tracar-letra", selo="ESCREVA A LETRA", conceito="objetivo1",
    enunciado="Passe o dedo pelas bolinhas e <b>escreva a letra</b>.",
    dica="Comece na bolinha 1, que está piscando, e siga as setinhas.",
    dados=[
      {"selo":"A LETRA A","letra":"A","voz":"Á","som":"Á de ABELHA","palavra":"ABELHA","img":"tr_abelha",
       "enun":"Ela tem duas pernas e um cinto no meio. Comece embaixo, na bolinha <b>1</b>.",
       "hint":"Suba a primeira perna, desça a outra e depois faça o cinto no meio.",
       "msg":"Você escreveu a letra <b>A</b>! A de ABELHA.",
       "tracos":[{"pts":[[16,88],[50,14]]},{"pts":[[50,14],[84,88]]},{"pts":[[30,58],[70,58]]}]},
      {"selo":"A LETRA O","letra":"O","voz":"Ó","som":"Ó de OVO","palavra":"OVO","img":"tr_ovo",
       "enun":"Esta é uma <b>volta</b> só. Comece em cima, na bolinha <b>1</b>, e dê a volta.",
       "hint":"Faça uma bola bem redonda, como um ovo, sem levantar o dedo.",
       "msg":"Você escreveu a letra <b>O</b>! O de OVO.",
       "tracos":[{"pts":[[64,20],[36,22],[20,48],[28,76],[56,84],[80,64],[78,34],[64,20]]}]},
    ])
...
add(id="f05", mec="ligar", selo="LIGUE", conceito="objetivo1",
    ...
    dados=[{"k":"p0","t":"PATO","s":"Começa com P"},
           {"k":"p1","t":"UVA","s":"Começa com U"},
           {"k":"p2","t":"DADO","s":"Começa com D"},
           {"k":"p3","t":"VACA","s":"Começa com V"}],
    dadosExtra={"DICAS":[
...
# f09 — LIGAR-PONTOS: revela a letra L (com a letra brilhando no fim)
add(id="f09", mec="ligar-pontos", selo="LIGUE OS PONTOS", conceito="objetivo1",
    enunciado="Ligue os <b>pontos</b> na ordem e descubra a letra escondida.",
    dica="Comece no ponto 1, que está piscando, e vá até o próximo número.",
    dados=[
      {"selo":"A LETRA ESCONDIDA","nome":"a letra L","voz":"a letra ele, de leão",
       "pts":[[36,14],[36,44],[36,82],[62,82],[84,82]],
       "d":"M36 14 L50 14 L50 68 L84 68 L84 82 L36 82 Z",
       "cor":"#7ec8e3",
       "extra":"<path d='M40 20 L46 20 L46 62 L80 62 L80 74 L40 74 Z' fill='rgba(255,255,255,.25)'/>"},
    ],
    dadosExtra={"DICAS":[
      "Siga os números em ordem: 1, 2, 3... o desenho aparece sozinho.",
      "O próximo ponto está brilhando. Toque bem em cima dele.",
      "Deixa comigo: eu ligo este e você continua."]})
...
add(id="f11", mec="tracar-letra", selo="ESCREVA A LETRA", conceito="objetivo1",
    enunciado="Escreva mais duas letras com o dedo.",
    dica="Siga as bolinhas na ordem dos números.",
    dados=[
      {"selo":"A LETRA L","letra":"L","voz":"EL","som":"EL de LEÃO","palavra":"LEÃO","img":"tr_leao",
       "enun":"O L desce reto e vira um pezinho. Comece em cima, na bolinha <b>1</b>.",
       "hint":"Primeiro desça reto; lá embaixo, faça o pezinho para a direita.",
       "msg":"Você escreveu a letra <b>L</b>! L de LEÃO.",
       "tracos":[{"pts":[[34,12],[34,46],[34,80],[60,80],[86,80]]}]},
      {"selo":"A LETRA T","letra":"T","voz":"tê","som":"tê de TREM","palavra":"TREM","img":"tr_trem",
       "enun":"O T tem <b>dois traços</b>: faça o chapéu (1 ao 3), levante o dedo e desça o pauzinho.",
       "hint":"Primeiro o chapeuzinho, da esquerda para a direita. Depois o pauzinho, de cima para baixo.",
       "msg":"Você escreveu a letra <b>T</b>! T de TREM.",
       "tracos":[{"pts":[[14,18],[50,18],[86,18]]},{"pts":[[50,18],[50,52],[50,86]]}]},
    ])
...
add(id="f12", mec="bater-silabas", selo="BATA AS SÍLABAS", conceito="objetivo2",
    enunciado="Diga a palavra devagar e <b>bata</b> uma vez para cada pedaço.",
    dica="Ponha a mão no queixo: ele desce a cada pedaço da palavra.",
    dados=[
...
add(id="f14", mec="escolher", selo="MESMA SÍLABA", conceito="objetivo2",
    enunciado="Ache a <b>palavra</b> que começa com a sílaba.",
    dica="Diga cada palavra e escute o primeiro pedaço dela.",
    dados=[
      {"p":"Qual palavra começa com a sílaba <b>SA</b>?",
       "c":{"t":"SAPO","img":"tr_sapo","voz":"sapo"},
       "e":[{"t":"GATO","img":"tr_gato","voz":"gato"},
            {"t":"BOLA","img":"tr_bola","voz":"bola"},
       ...
       "d":["Diga cada nome e escute o PRIMEIRO pedaço.",
            ...
            "É o SAPO. Ele está aceso: toque nele para seguir."]},
      {"p":"Qual palavra começa com a sílaba <b>CA</b>?",
       ...
       "d":["Escute o comecinho de cada palavra.",
            ...
            "É a CASA. Ela está acesa: toque nela para seguir."]},
                   ...
                   "FECHO":"Você acha palavras pela sílaba do começo!"})
...
add(id="f17", mec="bater-silabas", selo="BATA AS SÍLABAS", conceito="objetivo2",
    enunciado="Agora palavras <b>maiores</b>: bata uma vez para cada pedaço.",
    dica="Diga bem devagar e conte quantos pulinhos a boca dá.",
    dados=[
      ...
      {"pal":"JACARÉ","sil":["JA","CA","RÉ"],"voz":"ja... ca... ré","fig":"tr_jacare",
       "d":["Ponha a mão no queixo e diga JA-CA-RÉ.",
            "Conte as vezes que o queixo desce.",
            "São <b>3</b> pedaços: ja... ca... ré. Toque em Pronto."]},
    ])
